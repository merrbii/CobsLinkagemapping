...
p1.bin <- df.bin.subset  %>% 
  ...
  scale_y_continuous(name=NULL, breaks = c(-5,-4,-3))+
  theme_classic2()+
...
grob <- grobTree(textGrob(expression(pi), 
                          gp=gpar(col="grey", fontsize=80, fontface="bold",alpha=.5, fontfamily = "Georgia")))
# Plot
...
t1.bin <- df.bin.subset  %>% 
  ...
  scale_y_continuous(name=NULL, breaks = c(-2,-1,0,1,2))+
  theme_classic2()+
...
grob <- grobTree(textGrob(expression(paste("Taj", italic(D))),
                          gp=gpar(col="grey", fontsize=60, fontface="bold",alpha=.5, fontfamily = "Georgia")))
# Plot
...
f1.bin <- df.bin.subset  %>% 
  ...
  scale_y_continuous(name=NULL, breaks = c(0,.3,.6,.9))+
  theme_classic2()+
  theme(axis.text = element_text(angle = 0,face="bold",size=10),
        legend.position = "none",
        axis.text.x = element_blank(),
...
d1.bin <- df.bin.subset  %>% 
  ...
  scale_y_continuous(name=NULL, breaks = c(-3.5,-3.0,-2.5,-2))+
  theme_classic2()+
  theme(axis.text = element_text(angle = 0,face="bold",size=10),
        legend.position = "none",
        panel.border = element_rect(colour = "black", fill=NA, size=1))
...
grob <- grobTree(textGrob(expression(paste(italic(d)[xy])),
                          gp=gpar(col="grey", fontsize=65, fontface="bold",alpha=.5, fontfamily = "Georgia")))
# Plot
